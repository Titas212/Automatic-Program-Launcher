...
class FindingProgram:
    def __init__(self, scheduler, laikas):
        ...
        for subdir, dirs, files in os.walk(root_folder):
            for file in files:
                ...
                if result:
                    ...
                    self.full_file_path = result
                else:
                    print('Programa nerasta.')
...
def main():
    ...
    laikas = args.laikas
    finding_program_class = FindingProgram(scheduler = schedule, laikas = laikas)
